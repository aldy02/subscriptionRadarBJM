    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">View all your subscription transactions</p>
        </div>
                    ...
                    <div className="border-t pt-4">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <a 
                            href={`/uploads/payments/${transaction.proof_payment}`} 
                            target="_blank" 
                    ...
                    {transaction.status === 'pending' && (
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-yellow-700">Your payment is being verified by our admin team. This usually takes up to 24 hours.</p>
                        </div>
                      </div>
                    )}
                    ...
                    {transaction.status === 'accepted' && (
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-700">Your subscription has been activated successfully. Enjoy your premium access!</p>
                        </div>
                      </div>
                    )}
                    ...
                    {transaction.status === 'rejected' && (
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-red-700">Your payment was not approved. Please contact support or try again with correct payment details.</p>
